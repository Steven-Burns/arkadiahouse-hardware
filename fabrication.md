...
1. put one 5mm magnet in each of the holes through the bottom plate (which is now facing upward).  Push the magnets down through the middle plate so that they make firm and flat contact with the top plate.
1. carefully lift the bottm+middle assembly up to reveal the magnets that are now on the underside of the top plate.
1. let the glue set.
